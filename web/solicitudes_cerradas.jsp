<%-- 
    Document   : newjsp1
    Created on : 09-abr-2021, 15:33:51
    Author     : SEBASTIAN
--%>
<%@ page import="ModeloDAO.SolcitudesDAO" %>
...
<section class="full-width pageContent">
			...
			<div class="full-width header-well-text">
				<p class="text-condensedLight">
					Etimado trabajador seleccione el trámite que resolverá.  </p>   
       ...
       <div class="row">
           <div class="col-lg-12">
            <table id="example" class="table table-striped table-bordered" style="width:100%">
                <button onclick="exportTableToExcel('example')" class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" >Exportar en archivo Excel</button>
              ...
              <thead>
                ...
                <tbody>
                            <%
                                        ...
                                        for(Solicitudes sol:datos){
                                         %>
                    
                   <tr>
                                                    <td ><%= sol.getCodigo_alumno()  %></td>
                                                    <td ><%= sol.getNombre() +"  "+ sol.getApellidos() %></td>
                                                     <td ><%= sol.getTramite() %></td>
							<td ><%=sol.getFecha() %></td>
                                                        <td ><%=sol.getTrabajador() %></td>
